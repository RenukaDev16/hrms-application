...
public class EmpDaoImpl implements EmpDao {
  ...
  public List<EmployeeEntry> getLog() throws DataAccessException {
    try {
      String query =
          "select user_id ,record_timestamp ,record_type from biometric_logs order by user_id,record_timestamp,record_type";
